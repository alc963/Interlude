...
**Post-conditions:**
The user has a new friend in their friends list

**Success Scenarios:**
1. The user views a potential friends profile.
2. The user sends a friend request to that profile.
3. The system notifies the potential friend user of the friend request.
4. The potential friend user accepts the friend request.
5. The system marks both of them as a friend pair.

**Alternate Scenarios:** (Unsuccessfull)
- 4a. The potential friend declines the friend request.
1. The system marks the friend transaction as declined. 
...
# Issue Tracker
![Use Cases UML](images/issue_tracker.png)
